...
function setup_buffer_2() {
    white_index_buffer = gl.createBuffer();
    gl.bindBuffer( gl.ELEMENT_ARRAY_BUFFER, white_index_buffer);
    var white_index_number = [
          0, 2, 3,
          0, 4, 5,
          0, 6, 7,
          0, 8, 1
    ];
    gl.bufferData( gl.ELEMENT_ARRAY_BUFFER, new Uint16Array( white_index_number),
                   gl.STATIC_DRAW);
    white_index_buffer.size = white_index_number.length;
}
