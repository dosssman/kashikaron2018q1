function main()
{
    ...
    var faces = [
        [ 0, 1, 2 ], // f0
        //Adding new face with new vertex
        [ 0, 2, 3 ], // f1
    ];
    ...
    var scalars = [
        ...
        .2,   // S1
        .8,   // S2
        //Adding new color for the fouth vertex
        .5    //S3
    ];
    ...
    // Take normalized scalar from [.1, .8], find the interval it belongs to
    // in the cmap, returns the lowest bound
    //Flaws: If scalar value is not normalized, weird result
